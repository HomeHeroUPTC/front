// HomeClient.js
  ...
  import Agenda from '../../src/components/Agenda.js';
  ...
  const ProfileScreen = () => {
    ...
    return (
      <View style={styles.container}>
        ...
        {/* El Footer está dentro de la vista principal y permanecerá fijo en la parte inferior */}
  ...
  const styles = StyleSheet.create({
      ...
      button:{
        ...
        maxWidth: 200, // Establece un ancho máximo para el contenedor del botón
        height: 26,
        alignSelf: 'center', // Centra el contenedor del botón en el centro del padre
        marginVertical: 0, // Ajusta el margen vertical según tus preferencias
      },
      info:{
        marginTop:10,
      },
